...
class AppsRepository {
    ...
    @Volatile private var mInstalledListPrepared = false
    ...
    fun previewInstallList() {
        try {
            synchronized(mInstalledList) {
                ...
                mInstalledListPrepared = true
                Log.d(TAG, "previewInstallList: loaded ${installedList.size} apps")
            }
        } catch (e: Exception) {
